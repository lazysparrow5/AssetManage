...
Const TYPE_FILTER_CELL As String = "B1"        ' 类型输入位置
Const NAME_FILTER_CELL As String = "F1"     ' 名称输入位置
Const TARGET_ROW_START As Long = 11       ' 目标起始行
Const TYPE_COLUMN As Long = 8             ' 设备类型列号
